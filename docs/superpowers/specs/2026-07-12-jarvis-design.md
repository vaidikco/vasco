# Jarvis AI Assistant - System Design

## Overview
A high-end, integrated desktop AI assistant for Windows, designed for an immersive, "Jarvis-like" experience. The system is built incrementally, focusing on a fluid UI and an asynchronous core.
...
### Architecture
- **JarvisCore**: Central controller utilizing an `asyncio` event loop.
...
### Goal
Give Jarvis "brains" and the ability to interact with the OS.

### Components
- **LLM Integration**: API-based (e.g., Claude 3.5 Sonnet or GPT-4o) with a tailored "Jarvis" personality.
